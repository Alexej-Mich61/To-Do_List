...
import os
load_dotenv() # загружает переменные из файла .env в той же директории, что и settings.py
...
CSRF_TRUSTED_ORIGINS = [
    'https://alexej-mich61-to-do-list-622d.twc1.net',
    'http://alexej-mich61-to-do-list-622d.twc1.net', # Добавьте ваш домен сюда
]
...
INSTALLED_APPS = [
    ...
    'todos',  # Добавляем приложение todos в список
]
